...
cfg_match::cfg_match! {
    feature = "nightly" => {
        impl<F: ?Sized + FnOnce(I) -> Result<I, O, E>, O, I, E: ParseError<I>> ParseOnce<I, E> for F {
            type Output = O;
        ...
        impl<F: ?Sized + FnMut(I) -> Result<I, O, E>, O, I, E: ParseError<I>> ParseMut<I, E> for F {
            fn parse_mut(&mut self, input: I) -> Result<I, Self::Output, E> {
                self(input)
            }
        }

        impl<F: ?Sized + Fn(I) -> Result<I, O, E>, O, I, E: ParseError<I>> Parse<I, E> for F {
    ...
    _ => {
        impl<F: FnOnce(I) -> Result<I, O, E>, O, I, E: ParseError<I>> ParseOnce<I, E> for F {
            type Output = O;
        ...
        impl<F: FnMut(I) -> Result<I, O, E>, O, I, E: ParseError<I>> ParseMut<I, E> for F {
            fn parse_mut(&mut self, input: I) -> Result<I, Self::Output, E> {
                self(input)
            }
        }

        impl<F: Fn(I) -> Result<I, O, E>, O, I, E: ParseError<I>> Parse<I, E> for F {
            fn parse(&self, input: I) -> Result<I, Self::Output, E> {
                self(input)
            }
        }
